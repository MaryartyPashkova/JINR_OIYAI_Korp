...
function saveUserBuildingLine(building_id, floor_id, object_type, str_data) {
    url = 'https://lt-svr230.jinr.ru:8082/save_user_object_data?' + "building_id=" + building_id.toString() +
        "&floor_num=" + floor_id + "&object_type=" + object_type.toString() + "&json=" + str_data.toString();
//    url = 'http://127.0.0.1:8082/save_object_data?' + "building_id=" + building_id.toString() +
//         "&floor_num=" + floor_id + "&object_type=" + object_type.toString() + "&json=" + str_data.toString();
    fetch(url)
...
function loadUserBuildingLine(building_id, floor_id, object_type, func) {
    let url = 'https://lt-svr230.jinr.ru:8082/load_user_object_data?' + "building_id=" + building_id.toString() +
        "&floor_num=" + floor_id + "&object_type=" + object_type.toString();
//    let url = 'http://127.0.0.1:8082/load_object_data?' + "building_id=" + building_id.toString() +
//         "&floor_num=" + floor_id + "&object_type=" + object_type.toString();
    fetch(url)
...
//сохранение пользовательских иконок
function saveUserBuildingIcon(building_id, floor_id, object_type, str_data) {
    url = 'https://lt-svr230.jinr.ru:8082/save_user_object_data?' + "building_id=" + building_id.toString() +
        "&floor_num=" + floor_id + "&object_type=" + object_type.toString() + "&json=" + str_data.toString();
//    url = 'http://127.0.0.1:8082/save_object_data?' + "building_id=" + building_id.toString() +
//         "&floor_num=" + floor_id + "&object_type=" + object_type.toString() + "&json=" + str_data.toString();
...
function loadUserBuildingIcon(building_id, floor_id, object_type, func) {
    let url = 'https://lt-svr230.jinr.ru:8082/load_user_object_data?' + "building_id=" + building_id.toString() +
        "&floor_num=" + floor_id + "&object_type=" + object_type.toString();
//    let url = 'http://127.0.0.1:8082/load_object_data?' + "building_id=" + building_id.toString() +
//         "&floor_num=" + floor_id + "&object_type=" + object_type.toString();
...
//сохранение пользовательского объекта
function saveUserBuildingObject(building_id, floor_id, object_type, str_data) {
    url = 'https://lt-svr230.jinr.ru:8082/save_all_rooms?' + "b_id=" + building_id.toString() +
        "&fl_num=" + floor_id + "&floor_info=" + str_data.toString();
//    url = 'http://127.0.0.1:8082/save_object_data?' + "building_id=" + building_id.toString() +
//         "&floor_num=" + floor_id + "&object_type=" + object_type.toString() + "&json=" + str_data.toString();
    fetch(url)
        .then((response) => {
...
function loadUserBuildingObject(building_id, floor_id, object_type, func) {
    let url = 'https://lt-svr230.jinr.ru:8082/load_floor?' + "b_id=" + building_id.toString() +
        "&fl_num=" + floor_id;
//    let url = 'http://127.0.0.1:8082/load_object_data?' + "building_id=" + building_id.toString() +
//        "&floor_num=" + floor_id + "&object_type=" + object_type.toString();
    fetch(url)
...
//    let url = 'http://127.0.0.1:8082/get_buildings';
    fetch(url).then((response) => {
        ...
        document.getElementById('select_get_building_id').selectedIndex=54;
    });
}
...
//    let url = 'http://127.0.0.1:8082/get_types';
    fetch(url).then((response) => {
        ...
        console.log(data);
        //оставлены значения с именем marker*
        var sel_mark = document.getElementById(div_id);
        let sel_mark_len = document.getElementById(div_id).options;
        console.log(sel_mark);
        for(i=0; i< sel_mark.length; i++){
            
                console.log(sel_mark.options[i]);
